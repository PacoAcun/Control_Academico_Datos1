...
CREATE TABLE `Pensum` (
  ...
  `Carrera_Codigo` varchar(255) NOT NULL,
  `Estado` varchar(255) NOT NULL,
  PRIMARY KEY (`Codigo`,`Carrera_Codigo`),
  KEY `Carrera_Codigo` (`Carrera_Codigo`),
  CONSTRAINT `Pensum_ibfk_1` FOREIGN KEY (`Carrera_Codigo`) REFERENCES `Carrera` (`codigo`)
...
INSERT INTO `Pensum` VALUES ('CSP1','CS','Activo');
